...
class SessionReportPdfRenderer {
  ...
  static List<pw.Widget> _frequencySection(
    ...
    List<ReportEntry> otherFrequencyEntries,
    Uint8List? mapImage,
  ) {
  ...
  static pw.Widget _stationsTable(List<ReportEntry> entries) =>
  ...
  static List<String> _stationRow(ReportEntry entry) => [
