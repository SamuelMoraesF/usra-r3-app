...
void main() {
  test('formats meters below 1000 and kilometers from 1000 with one decimal', () {
  ...
  test('distance and midpoint of a one-degree equatorial segment', () {
    ...
    final label = routeDistances([ContactRoute([a, b])]).single;
  ...
  test('via routes label both legs and shared or reversed legs only once', () {
    ...
    expect(routeDistances([const ContactRoute([a, a])]), isEmpty);
  });
}
